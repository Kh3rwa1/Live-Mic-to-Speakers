...
public final class ToolUi {
    ...
    public static void level(Activity activity, int percent) {
        ...
        try {
            android.view.View meter = activity.findViewById(R.id.studio_input_level);
            android.view.View label = activity.findViewById(R.id.studio_level_value);
            if (meter instanceof ProgressBar) ((ProgressBar) meter).setProgress(value);
            if (label instanceof TextView) ((TextView) label).setText(
