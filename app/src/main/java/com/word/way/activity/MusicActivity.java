...
public class MusicActivity extends AppCompatActivity {
    ...
    private com.airbnb.lottie.LottieAnimationView lottieEqualizer;
    ...
    @Override public void onCreate(Bundle state) {
        ...
        play.setColorFilter(androidx.core.content.ContextCompat.getColor(this, R.color.quality_text));
        title = findViewById(R.id.textViewTitle);
        duration = findViewById(R.id.textViewDuration);
        elapsed = findViewById(R.id.textViewElapsedTime);
        seek = findViewById(R.id.seekBar);
        lottieEqualizer = findViewById(R.id.lottie_player_equalizer);
    ...
    private void refresh() {
        ...
        play.setContentDescription(getString(autoplay ? R.string.tool_pause : R.string.tool_play));
        if (autoplay) {
            if (lottieEqualizer != null && !lottieEqualizer.isAnimating()) lottieEqualizer.playAnimation();
        } else {
            if (lottieEqualizer != null && lottieEqualizer.isAnimating()) lottieEqualizer.pauseAnimation();
        }
    }
